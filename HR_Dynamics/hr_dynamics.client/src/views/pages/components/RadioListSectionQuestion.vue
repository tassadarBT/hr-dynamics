...
<template>
    <div class="grid" :id="'q' + question.displayOrder" :invalid="question.invalid && question.dirty">
        <div class="col-12">
            <Panel>
                <div class="grid">
                    <div class="col-7">
                        <p class="font-bold" :invalid="question.invalid && question.dirty">{{question.displayOrder}}. {{question.text}}</p>
                    </div>
                    <div class="col-5">
                        <div class="flex flex-wrap gap-4" :invalid="question.invalid && question.dirty">
